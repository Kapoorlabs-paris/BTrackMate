...
import static fiji.plugin.globalbtrackmate.gui.Icons.CAPTURE_DECORATED_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.CAPTURE_UNDECORATED_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.DISPLAY_DECORATIONS_ON_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.LINKING_OFF_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.LINKING_ON_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.REFRESH_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.RESET_ZOOM_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.SELECT_STYLE_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.THUMBNAIL_OFF_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.THUMBNAIL_ON_ICON;
...
public class TrackSchemeToolbar extends JToolBar {
	...
	private void init() {
		...
		toggleThumbnailsButton.setToolTipText(
				"<html>If enabled, spot thumnails will be captured <br/>" + "Can take long for large models.</html>");
