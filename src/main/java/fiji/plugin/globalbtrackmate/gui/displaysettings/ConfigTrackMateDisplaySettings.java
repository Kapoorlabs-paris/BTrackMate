...
import static fiji.plugin.globalbtrackmate.gui.Icons.APPLY_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.RESET_ICON;
...
public class ConfigTrackMateDisplaySettings implements Command {
	...
	@Override
	public void run() {
		editor(DisplaySettingsIO.readUserDefault(), "Configure the default settings to be used by TrackMate.",
	...
	public static JFrame editor(final DisplaySettings ds, final String titleStr, final String frameName) {
		...
		final JLabel title = new JLabel("<html><i>" + titleStr + "</i></html>");
		...
		final JScrollPane scrollPane = new JScrollPane(editor, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
