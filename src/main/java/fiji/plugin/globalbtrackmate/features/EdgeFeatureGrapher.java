...
import fiji.plugin.globalbtrackmate.util.XYEdgeRenderer;
import fiji.plugin.globalbtrackmate.util.XYEdgeSeries;
import fiji.plugin.globalbtrackmate.util.XYEdgeSeriesCollection;
...
public class EdgeFeatureGrapher extends AbstractFeatureGrapher {
	...
	public EdgeFeatureGrapher(final String xFeature, final Set<String> yFeatures, final List<DefaultWeightedEdge> edges,
	...
	private XYEdgeSeriesCollection buildConnectionDataSet(final List<String> targetYFeatures,
			final List<DefaultWeightedEdge> lEdges) {
	 ...
	 */
	private XYSeriesCollection buildEdgeDataSet(final Iterable<String> targetYFeatures,
			final Iterable<DefaultWeightedEdge> lEdges) {
