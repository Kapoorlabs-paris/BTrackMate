...
public class WizardPanel extends JPanel {
	...
	public void transition(final WizardPanelDescriptor to, final WizardPanelDescriptor from,
	...
	private class AnimatorPanel extends JPanel implements Paintable {
		...
		public void start(final WizardPanelDescriptor from, final WizardPanelDescriptor to, final Direction direction) {
			this.to = to;
			this.animator = new TransitionAnimator(from.getPanelComponent(), to.getPanelComponent(), direction,
					duration);
