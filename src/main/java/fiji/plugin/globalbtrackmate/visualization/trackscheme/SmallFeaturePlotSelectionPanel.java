...
import static fiji.plugin.globalbtrackmate.gui.Icons.PLOT_ICON;
...
import fiji.plugin.globalbtrackmate.gui.components.FeaturePlotSelectionPanel;
import fiji.plugin.globalbtrackmate.gui.components.FeaturePlotSelectionPanel.PlotAction;
...
public class SmallFeaturePlotSelectionPanel extends JPanel {
	...
	public SmallFeaturePlotSelectionPanel(final String xKey, final List<String> features,
			final Map<String, String> featureNames, final PlotAction plotAction) {
