package fiji.plugin.globalbtrackmate.tracking.overlap;

import static fiji.plugin.globalbtrackmate.gui.Fonts.BIG_FONT;
import static fiji.plugin.globalbtrackmate.gui.Fonts.FONT;
import static fiji.plugin.globalbtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_IOU_CALCULATION;
import static fiji.plugin.globalbtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_MIN_IOU;
import static fiji.plugin.globalbtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_SCALE_FACTOR;
...
import fiji.plugin.globalbtrackmate.tracking.overlap.OverlapTracker.IoUCalculation;
...
public class OverlapTrackerSettingsPanel extends ConfigurationPanel {
	...
	public OverlapTrackerSettingsPanel() {
		...
		labelTrackerDescription.setText(OverlapTrackerFactory.TRACKER_INFO_TEXT.replace("<br>", "")
				.replace("<p>", "<p align=\"justify\">").replace("<html>", "<html><p align=\"justify\">"));
	...
	public Map<String, Object> getSettings() {
		...
		final IoUCalculation method = (rdbtnFast.isSelected()) ? IoUCalculation.FAST : IoUCalculation.PRECISE;
	...
	public void setSettings(final Map<String, Object> settings) {
		...
		final boolean isFast = ((String) settings.get(KEY_IOU_CALCULATION))
				.equalsIgnoreCase(IoUCalculation.FAST.name());
