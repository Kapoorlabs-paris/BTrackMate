...
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_DOWNLEFT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_DOWNRIGHT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_DOWN_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_LEFT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_RIGHT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_UPLEFT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_UPRIGHT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ARROW_UP_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.EDIT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.END_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.HOME_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.RESET_ZOOM_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ZOOM_IN_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.ZOOM_OUT_ICON;
...
public class TrackSchemeActions {
	...
	private static class PanAction extends AbstractAction {
		...
		public PanAction(final String name, final Icon icon, final TrackSchemeGraphComponent graphComponent,
	...
	public static class EditAction extends AbstractAction {
		...
		private void multiEditSpotName(final TrackSchemeGraphComponent lGraphComponent,
