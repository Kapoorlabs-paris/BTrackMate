...
import fiji.plugin.globalbtrackmate.tracking.sparselap.costmatrix.CostMatrixCreator;
 ...
 * 
 * @param <K> the type of the source objects to link.
 * @param <J> the type of the target objects to link.
 */
public class JaqamanLinker<K extends Comparable<K>, J extends Comparable<J>> extends BenchmarkAlgorithm
	...
	/**
	 * Creates a new linker for the specified cost matrix creator. See Jaqaman <i>et
	 * al.</i>, Nature Methods, <b>2008</b>, Figure 1b.
	 * 
	 * @param costMatrixCreator the class in charge of creating linking costs.
	 * @param logger            a logger that will receive progress messages.
	 */
	 ...
	 * <p>
	 * It takes the shape of a map, such that if <code>source</code> is a key of the
	 * map, it is assigned to <code>target = map.get(source)</code>.
	 * 
	 ...
	 * <p>
	 * It takes the shape of a map, such that if <code>source</code> is a key of the
	 * map, its assignment as a cost <code>cost = map.get(source)</code>.
	 * 
	...
	public boolean process() {
		 ...
		 * Bottom right.
		 * 
		 * Alt. cost is the overall min of alternative costs. This deviate or extend a
		 * bit the u-track code.
		 */
