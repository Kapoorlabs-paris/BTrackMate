...
public class SpotNeighborhoodCursor<T extends RealType<T>> implements Cursor<T> {
	 ...
	 * the range [0, π].
	 * <p>
	 * In spherical coordinates, the inclination is the angle between the Z axis and
	 * the line OM where O is the sphere center and M is the point location.
	 */
	 ...
	 * <p>
	 * In spherical coordinates, the azimuth is the angle measured in the plane XY
	 * between the X axis and the line OH where O is the sphere center and H is the
	 * orthogonal projection of the point M on the XY plane.
	 */
