package fiji.plugin.globalbtrackmate.visualization.hyperstack;
...
public class SpotEditTool extends AbstractTool
	...
	private Spot makeSpot(final ImagePlus lImp, HyperStackDisplayer displayer, final ImageCanvas canvas,
			Point mouseLocation) {
		if (displayer == null) {
