package fiji.plugin.globalbtrackmate.gui.wizard;

import static fiji.plugin.globalbtrackmate.gui.Icons.SPOT_TABLE_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.TRACK_SCHEME_ICON_16x16;
import static fiji.plugin.globalbtrackmate.gui.Icons.TRACK_TABLES_ICON;
...
import fiji.plugin.globalbtrackmate.action.AbstractTMAction;
import fiji.plugin.globalbtrackmate.action.ExportAllSpotsStatsAction;
import fiji.plugin.globalbtrackmate.action.ExportStatsTablesAction;
...
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ActionChooserDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ChooseDetectorDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ChooseTrackerDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ConfigureViewsDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ExecuteDetectionDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ExecuteTrackingDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.GrapherDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.InitFilterDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.LogPanelDescriptor2;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.SaveDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.SpotDetectorDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.SpotFilterDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.SpotTrackerDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.StartDialogDescriptor;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.StartDialogDescriptorOrig;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.TrackFilterDescriptor;
...
import fiji.plugin.globalbtrackmate.visualization.trackscheme.SpotImageUpdater;
...
public class TrackMateWizardSequence implements WizardSequence {
	...
	private final StartDialogDescriptorOrig startDialogDescriptor;
	...
	public TrackMateWizardSequence(final TrackMate trackmate, final SelectionModel selectionModel,
		...
		startDialogDescriptor = new StartDialogDescriptorOrig(settings, logger);
		...
		actionChooserDescriptor = new ActionChooserDescriptor(new ActionProvider(), trackmate, selectionModel,
				displaySettings);
	...
	private SpotDetectorDescriptor getDetectorConfigDescriptor() {
		...
		final ConfigurationPanel detectorConfigurationPanel = detectorFactory
				.getDetectorConfigurationPanel(trackmate.getSettings(), trackmate.getModel());
		detectorConfigurationPanel.setSettings(defaultSettings);
		trackmate.getSettings().detectorSettings = defaultSettings;
		final SpotDetectorDescriptor configDescriptor = new SpotDetectorDescriptor(trackmate.getSettings(),
				detectorConfigurationPanel, trackmate.getModel().getLogger());
	...
	private SpotTrackerDescriptor getTrackerConfigDescriptor() {
		...
		final ConfigurationPanel trackerConfigurationPanel = trackerFactory
				.getTrackerConfigurationPanel(trackmate.getModel());
		trackerConfigurationPanel.setSettings(defaultSettings);
		trackmate.getSettings().trackerSettings = defaultSettings;
		final SpotTrackerDescriptor configDescriptor = new SpotTrackerDescriptor(trackmate.getSettings(),
				trackerConfigurationPanel, trackmate.getModel().getLogger());
