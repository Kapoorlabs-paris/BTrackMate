...
import static fiji.plugin.globalbtrackmate.gui.Icons.ORANGE_ASTERISK_ICON;
 ...
 * visible. Thus, btrackmate is utilisable for Fluorescence Recovery after
...
public class CloseGapsByLinearInterpolationAction extends AbstractTMAction {
	...
	public static final String INFO_TEXT = "<html>" + "This action closes gaps in tracks by introducing new spots. "
			+ "The spots positions and size are calculated " + "using linear interpolation." + "</html>";
	...
	private void interpolateFeature(final Spot targetSpot, final Spot spot1, final Spot spot2, final double weight,
