...
public class SpotImageUpdater {
	 ...
	 *
	 * @param settings the {@link Settings} object from which we read the raw image
	...
	/**
	 * Returns the image string of the given spot, based on the raw images contained
	 * in the given model. For performance, the image at target frame is stored for
	 * subsequent calls of this method. So it is a good idea to group calls to this
	 * method for spots that belong to the same frame.
	 *
