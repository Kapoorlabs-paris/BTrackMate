package fiji.plugin.globalbtrackmate.gui;
...
public class Icons {
	public static final ImageIcon SPOT_ICON = new ImageIcon(
			Icons.class.getResource("images/Icon1_print_transparency.png"));

	public static final ImageIcon EDGE_ICON = new ImageIcon(
			Icons.class.getResource("images/Icon2_print_transparency.png"));

	public static final ImageIcon TRACK_ICON = new ImageIcon(
			Icons.class.getResource("images/Icon3b_print_transparency.png"));

	public static final ImageIcon BRANCH_ICON = new ImageIcon(
			Icons.class.getResource("images/Icons4_print_transparency.png"));

	public static final ImageIcon TRACK_SCHEME_ICON = new ImageIcon(
			Icons.class.getResource("images/Icon3a_print_transparency.png"));

	public static final ImageIcon TRACKMATE_ICON = new ImageIcon(
			Icons.class.getResource("images/Logo50x50-color-nofont-72p.png"));
	...
	public static final ImageIcon TRACK_TABLES_ICON = new ImageIcon(
			Icons.class.getResource("images/table_multiple.png"));
	...
	public static final ImageIcon DISPLAY_CONFIG_ICON = new ImageIcon(
			Icons.class.getResource("images/wrench_orange.png"));
	...
	public final static ImageIcon SELECT_TRACK_ICON_UPWARDS = new ImageIcon(
			Icons.class.getResource("images/arrow_up.png"));

	public final static ImageIcon SELECT_TRACK_ICON_DOWNWARDS = new ImageIcon(
			Icons.class.getResource("images/arrow_down.png"));

	public static final ImageIcon CAMERA_EXPORT_ICON = new ImageIcon(
			Icons.class.getResource("images/camera_export.png"));
	...
	public static final ImageIcon CAPTURE_UNDECORATED_ICON = new ImageIcon(
			Icons.class.getResource("images/camera_go.png"));

	public static final ImageIcon CAPTURE_DECORATED_ICON = new ImageIcon(
			Icons.class.getResource("images/camera_edit.png"));

	public static final ImageIcon DISPLAY_DECORATIONS_ON_ICON = new ImageIcon(
			Icons.class.getResource("images/application_view_columns.png"));
