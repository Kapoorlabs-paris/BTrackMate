...
public class SpotIconGrabber<T extends RealType<T>> {
	...
	/**
	 * Returns the image string for the specified spot. The spot x,y,z and radius
	 * coordinates are used to get a location on the image given at construction.
	 * Physical coordinates are transformed in pixel coordinates thanks to the
	 * calibration stored in the {@link ImgPlus}.
	 *
	 * @param spot         the spot to generate a thumbnail image from.
	 * @param radiusFactor a factor that determines the size of the thumbnail. The
	 *                     thumbnail will have a size equal to the spot diameter
	 *                     times this radius.
	 */
	 ...
	 * @param slice  z-slice index.
	 * @param width  width of the extract.
	 * @param height height of the extract.
	 * @return a new {@link Img} containing the extract, potentially padded with 0s.
	 */
	 ...
	 * @param x      top-left x coordinate.
	 * @param y      top left y coordinate.
	 * @param slice  central z-slice index.
	 * @param width  width of the extract.
	 * @param height height of the extract.
	 * @param depth  depth (along z) of the extract.
	 * @return a new {@link Img} containing the extract, potentially padded with 0s.
	 */
	public final Img<T> grabImage(final long x, final long y, final long slice, final long width, final long height,
			final long depth) {
