...
public class SpotIntensityMultiCAnalyzerFactory<T extends RealType<T> & NativeType<T>>
	...
	private static final List<String> FEATURES = Arrays.asList(new String[] { MEAN_INTENSITY, MEDIAN_INTENSITY,
			MIN_INTENSITY, MAX_INTENSITY, TOTAL_INTENSITY, STD_INTENSITY });
	private static final List<String> FEATURE_SHORTNAMES = Arrays.asList(new String[] { MEAN_SHORT_NAME,
			MEDIAN_SHORT_NAME, MIN_SHORT_NAME, MAX_SHORT_NAME, SUM_SHORT_NAME, STD_SHORT_NAME });
	private static final List<String> FEATURE_NAMES = Arrays
			.asList(new String[] { MEAN_NAME, MEDIAN_NAME, MIN_NAME, MAX_NAME, SUM_NAME, STD_NAME });
