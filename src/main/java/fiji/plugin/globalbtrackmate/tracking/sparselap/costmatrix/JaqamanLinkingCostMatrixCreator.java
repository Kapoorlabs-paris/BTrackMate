...
public class JaqamanLinkingCostMatrixCreator<K extends Comparable<K>, J extends Comparable<J>>
	...
	public JaqamanLinkingCostMatrixCreator(final Iterable<K> sources, final Iterable<J> targets,
			final CostFunction<K, J> costFunction, final double costThreshold, final double alternativeCostFactor,
	...
	public boolean process() {
		...
		if (accSources.isEmpty() || accTargets.isEmpty()) {
			...
			final DefaultCostMatrixCreator<K, J> cmCreator = new DefaultCostMatrixCreator<>(accSources, accTargets,
					costs.data, alternativeCostFactor, percentile);
