package fiji.plugin.globalbtrackmate.io;

import static fiji.plugin.globalbtrackmate.detection.DetectorKeys.XML_ATTRIBUTE_DETECTOR_NAME;
import static fiji.plugin.globalbtrackmate.io.IOUtils.readBooleanAttribute;
import static fiji.plugin.globalbtrackmate.io.IOUtils.readDoubleAttribute;
import static fiji.plugin.globalbtrackmate.io.IOUtils.readIntAttribute;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.ANALYSER_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.ANALYSER_KEY_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.ANALYZER_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_TEND_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_TSTART_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_XEND_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_XSTART_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_YEND_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_YSTART_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_ZEND_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.CROP_ZSTART_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.DETECTOR_SETTINGS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.DISPLAY_SETTINGS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.EDGE_ANALYSERS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.EDGE_FEATURES_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_DECLARATIONS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_DIMENSION_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_ISINT_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_NAME_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FEATURE_SHORT_NAME_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FILTERED_TRACK_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FILTER_ABOVE_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FILTER_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FILTER_FEATURE_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FILTER_VALUE_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.FRAME_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.GUI_STATE_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.GUI_STATE_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.GUI_VIEW_ATTRIBUTE;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.GUI_VIEW_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_FILENAME_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_FOLDER_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_HEIGHT_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_NFRAMES_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_NSLICES_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_PIXEL_HEIGHT_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_PIXEL_WIDTH_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_TIME_INTERVAL_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_VOXEL_DEPTH_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.IMAGE_WIDTH_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.INITIAL_SPOT_FILTER_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.LOG_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.MODEL_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.PLUGIN_VERSION_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.ROI_N_POINTS_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SETTINGS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPATIAL_UNITS_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_ANALYSERS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_COLLECTION_NSPOTS_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_FEATURES_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_FILTER_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_FRAME_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_ID_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.SPOT_NAME_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TIME_UNITS_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACKER_SETTINGS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_ANALYSERS_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_EDGE_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_FEATURES_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_FILTER_COLLECTION_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_ID_ELEMENT_KEY;
import static fiji.plugin.globalbtrackmate.io.TmXmlKeys.TRACK_NAME_ATTRIBUTE_NAME;
import static fiji.plugin.globalbtrackmate.tracking.TrackerKeys.XML_ATTRIBUTE_TRACKER_NAME;
...
import fiji.plugin.globalbtrackmate.SpotRoi;
import fiji.plugin.globalbtrackmate.Logger.StringBuilderLogger;
import fiji.plugin.globalbtrackmate.detection.SpotDetectorFactory;
import fiji.plugin.globalbtrackmate.detection.SpotDetectorFactoryBase;
...
import fiji.plugin.globalbtrackmate.features.edges.EdgeTargetAnalyzer;
import fiji.plugin.globalbtrackmate.features.spot.SpotAnalyzerFactory;
import fiji.plugin.globalbtrackmate.features.spot.SpotAnalyzerFactoryBase;
import fiji.plugin.globalbtrackmate.features.track.TrackAnalyzer;
import fiji.plugin.globalbtrackmate.features.track.TrackIndexAnalyzer;
import fiji.plugin.globalbtrackmate.gui.displaysettings.DisplaySettings;
import fiji.plugin.globalbtrackmate.gui.displaysettings.DisplaySettingsIO;
import fiji.plugin.globalbtrackmate.gui.wizard.descriptors.ConfigureViewsDescriptor;
import fiji.plugin.globalbtrackmate.providers.DetectorProvider;
import fiji.plugin.globalbtrackmate.providers.EdgeAnalyzerProvider;
import fiji.plugin.globalbtrackmate.providers.SpotAnalyzerProvider;
import fiji.plugin.globalbtrackmate.providers.SpotMorphologyAnalyzerProvider;
import fiji.plugin.globalbtrackmate.providers.TrackAnalyzerProvider;
import fiji.plugin.globalbtrackmate.providers.TrackerProvider;
import fiji.plugin.globalbtrackmate.providers.ViewProvider;
...
import fiji.plugin.globalbtrackmate.visualization.trackscheme.TrackScheme;
import ij.IJ;
import ij.ImagePlus;
...
public class TmXmlReader {
	 ...
	 * recreate both the filtered spot collection and the tracks graph from the same
	 * spot objects that the main spot collection.. In the file, they are referenced
	 * by their {@link Spot#ID()}, and parsing them all to retrieve the one with the
	 * right ID is a drag. We made this cache a {@link ConcurrentHashMap} because we
	 * hope to load large data in a multi-threaded way.
	 */
	 ...
	 *
	 * @param provider        the {@link ViewProvider} to instantiate the view. Each
	 *                        saved view must be known by the specified provider.
	 * @param model           the model to display in the views.
	 * @param settings        the settings to build the views.
	 * @param selectionModel  the {@link SelectionModel} model that will be shared
	 *                        with the new views.
	 * @param displaySettings the display settings to pass to the view.
	...
	public Collection<TrackMateModelView> getViews(final ViewProvider provider, final Model model,
			final Settings settings, final SelectionModel selectionModel, final DisplaySettings displaySettings) {
		final Element guiel = root.getChild(GUI_STATE_ELEMENT_KEY);
		if (null != guiel) {
	...
	public Settings readSettings(final ImagePlus imp) {
		return readSettings(imp, new DetectorProvider(), new TrackerProvider(),
				new SpotAnalyzerProvider((imp == null) ? 1 : imp.getNChannels()), new EdgeAnalyzerProvider(),
	 ...
	 * @param imp
	 *
	 * @param detectorProvider      the detector provider, required to configure the
	 *                              settings with a correct
	 *                              {@link SpotDetectorFactory}. If
	 *                              <code>null</code>, will skip reading detector
	 *                              parameters.
	 * @param trackerProvider       the tracker provider, required to configure the
	 *                              settings with a correct
	 *                              {@link fiji.plugin.globalbtrackmate.tracking.SpotTracker}.
	 *                              If <code>null</code>, will skip reading tracker
	 *                              parameters.
	 * @param spotAnalyzerProvider  the spot analyzer provider, required to
	 *                              instantiates the saved
	 *                              {@link SpotAnalyzerFactory}s. If
	 *                              <code>null</code>, will skip reading spot
	 *                              analyzers.
	 * @param edgeAnalyzerProvider  the edge analyzer provider, required to
	 *                              instantiates the saved {@link EdgeAnalyzer}s. If
	 *                              <code>null</code>, will skip reading edge
	 *                              analyzers.
	 * @param trackAnalyzerProvider the track analyzer provider, required to
	 *                              instantiates the saved {@link TrackAnalyzer}s.
	 *                              If <code>null</code>, will skip reading track
	 *                              analyzers.
	 */
	public Settings readSettings(final ImagePlus imp, final DetectorProvider detectorProvider,
			final TrackerProvider trackerProvider, final SpotAnalyzerProvider spotAnalyzerProvider,
		...
		/*
		 * Backward compatibility: for now we add all the analyzers we know of at
		 * runtime. This kind of kills the need to read the analyzers list specified in
		 * the TrackMate file, but this gives a fully working application with the file
		 * loaded, and that can be saved without issues.
		 */
	 ...
	 * @param settings        the {@link Settings} to feed.
	 */
	...
	/**
	 * Update the given {@link Settings} object with the {@link SpotDetectorFactory}
	 * and settings map fields named {@link Settings#detectorFactory} and
	 * {@link Settings#detectorSettings} read within the XML file this reader is
	 * initialized with.
	 *
	 * @param settingsElement the Element in which the {@link Settings} parameters
	 *                        are stored.
	 * @param settings        the base {@link Settings} object to update.
	 * @param provider        a {@link DetectorProvider}, required to read detector
	 *                        parameters.
	 */
	protected void getDetectorSettings(final Element settingsElement, final Settings settings,
	 ...
	 *
	 * @param settingsElement the {@link Element} in which the tracker parameters
	 *                        are stored.
	 * @param settings        the base {@link Settings} object to update.
	 * @param provider        the {@link TrackerProvider}, required to read the
	 *                        tracker parameters.
	 */
	protected void getTrackerSettings(final Element settingsElement, final Settings settings,
	 ...
	 * to build the cache.
	 *
	 * @param modelElement the {@link Element} in which the model content was
	 *                     written.
	...
	protected boolean readTracks(final Element modelElement, final Model model) {
		...
		final SimpleWeightedGraph<Spot, DefaultWeightedEdge> graph = new SimpleWeightedGraph<>(
		...
		for (final Element trackElement : trackElements) {
			...
			for (final Element edgeElement : edgeElements) {
				...
				/*
				 * Add spots to connected set. We might add the same spot twice (because we
				 * iterate over edges) but this is fine for we use a set.
				 */
				...
				if (settings.imp == null) {
					...
					for (final Element child : children) {
						...
						if (null == spotAnalyzer) {
							/*
							 * Special case: if we cannot find a matching analyzer for a declared factory,
							 * then we will try to see whether it is a morphology spot analyzer, that are
							 * treated separately. If it is not, we give up.
							 */
