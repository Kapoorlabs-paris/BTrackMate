...
final public class EverythingDisablerAndReenabler { // v[1, 2016-12-05 14!30 UTC] by dreamspace-president.com
	 ...
	 *                                             components are to be recursively
	 *                                             disabled. The container itself
	 *                                             will not be disabled.
	 * @param componentClassesToBeIgnored          null or an array of classes (e.g.
	 *                                             containing JLabel.class) that
	 *                                             should be excluded from
	 *                                             disabling. Adding a Container
	 *                                             here does not affect the
	 *                                             recursive process.
	 * @throws IllegalArgumentException if the container argument is null. In case
	 *                                  someone wonders why I don't use
	 *                                  {@link NullPointerException} here: Null can
	 *                                  be a perfectly legal argument in other
	 *                                  places, but here, it is not. If an argument
	 *                                  does not check out, the choice of Exception,
	 *                                  of course, is IllegalArgument, not
	 *                                  NullPointer.
	 */
