 ...
 * {@link fiji.plugin.btrackmate.tracking.oldlap.LAPTracker}.
 * 
...
public class SimpleLAPTrackerSettingsPanel extends ConfigurationPanel {
	...
	public SimpleLAPTrackerSettingsPanel(final String trackerName, final String infoText, final String spaceUnits) {
		...
		this.add(lbl1, new GridBagConstraints(0, 0, 3, 1, 0.0, 0.0, GridBagConstraints.WEST,
		...
		this.add(lblTrackerDescription, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(10, 10, 10, 10), 0, 0));
		lblTrackerDescription.setFont(FONT.deriveFont(Font.ITALIC));
		lblTrackerDescription.setText(infoText.replace("<br>", "").replace("<p>", "<p align=\"justify\">")
				.replace("<html>", "<html><p align=\"justify\">"));

		final JLabel lbl2 = new JLabel();
		this.add(lbl2, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
		lbl2.setFont(FONT);
		lbl2.setText("Linking max distance:");

		final JLabel lbl3 = new JLabel();
		this.add(lbl3, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
		lbl3.setFont(FONT);
		lbl3.setText("Gap-closing max distance:");

		final JLabel lbl4 = new JLabel();
		this.add(lbl4, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
		lbl4.setFont(FONT);
		...
		this.add(txtfldLinkingDistance, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		...
		this.add(txtfldGapClosingDistanceCutoff, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		this.add(txtfldGapClosingTimeCutoff, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		this.add(lblMaxDistanceUnit, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
		...
		this.add(lblGapClosingMaxDistanceUnit, new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 10), 0, 0));
		...
		this.add(lblGapClosingTimeCutoffUnit, new GridBagConstraints(2, 6, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 10), 0, 0));
