...
import fiji.plugin.globalbtrackmate.Logger.SlaveLogger;
...
public class SparseLAPTracker extends MultiThreadedBenchmarkAlgorithm implements SpotTracker, Cancelable {
	...
	public boolean process() {
		...
		ftfSettings.put(KEY_TRACKLET_LENGTH, settings.get(KEY_TRACKLET_LENGTH));
		...
		slSettings.put(KEY_TRACKLET_LENGTH, settings.get(KEY_TRACKLET_LENGTH));
