...
public class ChartExporter {
	 ...
	 */
	public static void exportChartAsSVG(final JFreeChart chart, final Rectangle bounds, final File svgFile)
			throws IOException {
	 ...
	 */
	public static void exportChartAsPDF(final JFreeChart chart, final Rectangle bounds, final File pdfFile)
