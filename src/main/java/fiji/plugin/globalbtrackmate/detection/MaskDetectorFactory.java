...
import fiji.plugin.globalbtrackmate.gui.components.detector.MaskDetectorConfigurationPanel;
...
public class MaskDetectorFactory<T extends RealType<T> & NativeType<T>> extends ThresholdDetectorFactory<T> {
	...
	public static final String INFO_TEXT = "<html>" + "This detector creates spots from a black and white mask." + "<p>"
			+ "More precisely, all the pixels in the designated channel that have "
			+ "a value strictly larger than 0 are " + "considered as part of the foreground, "
