...
import static fiji.plugin.globalbtrackmate.features.FeatureUtils.USE_UNIFORM_COLOR_KEY;
...
public class DisplaySettings {
	 ...
	 * <i>E.g.</i> the numerical feature for this object calculated automatically,
	 ...
	 * assigned yet. <i>E.g</i> the coloring uses a manual feature, but this object
	 * did not receive a value yet.
	 */
	...
	public enum TrackDisplayMode {
		 ...
		 * are faded in the background. How much can be seen is defined by the value of
		 * the frame-display-depth.
		 */
		LOCAL("Show tracks local in time"),

		/**
		 * Track display mode where the only part of the tracks close to the current
		 * time-point are drawn, backward only. How much can be seen is defined by the
		 * value of the frame-display-depth.
		 */
		LOCAL_BACKWARD("Show tracks backward in time"),

		/**
		 * Track display mode where the only part of the tracks close to the current
		 * time-point are drawn, forward only. How much can be seen is defined by the
		 * value of the frame-display-depth.
		 */
