package fiji.plugin.globalbtrackmate.features.track;
...
public abstract class AbstractTrackAnalyzer implements TrackAnalyzer {
	...
	public AbstractTrackAnalyzer(final String key, final String name, final List<String> features,
			final Map<String, String> featureNames, final Map<String, String> featureShortNames,
			final Map<String, Dimension> featureDimensions, final Map<String, Boolean> isInts) {
		this.key = key;
		this.name = name;
