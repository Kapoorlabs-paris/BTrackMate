...
public class BoundaryTrack {
	...
	public void ShowBoundaryTime() {
		...
		if (parent.jpb != null && parent.thirdDimension == parent.AutoendTime) {
			...
			utility.BudProgressBar.SetProgressBar(parent.jpb, 100, "Skeletons Created, Push Track Buddies Button");
	...
	public void Common(int percent) {
		...
		RandomAccessibleInterval<IntType> BudSeg = utility.BudSlicer.getCurrentBudView(parent.Segoriginalimg,
				(int) parent.thirdDimension, (int) parent.thirdDimensionSize);
		GetPixelList(BudSeg);
