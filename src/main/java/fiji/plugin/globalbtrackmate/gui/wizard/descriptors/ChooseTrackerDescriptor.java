...
import fiji.plugin.globalbtrackmate.gui.components.ModuleChooserPanel;
...
public class ChooseTrackerDescriptor extends WizardPanelDescriptor {
	...
	private void setCurrentChoiceFromPlugin() {
		...
		final ModuleChooserPanel<SpotTrackerFactory> component = (fiji.plugin.globalbtrackmate.gui.components.ModuleChooserPanel<SpotTrackerFactory>) targetPanel;
	...
	public void aboutToHidePanel() {
		...
		if (null == factory) {
			btrackmate.getModel().getLogger().error("[ChooseTrackerDescriptor] Cannot find tracker named " + trackerKey
