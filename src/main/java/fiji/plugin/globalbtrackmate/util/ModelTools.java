...
import fiji.plugin.globalbtrackmate.tracking.kdtree.NearestNeighborTracker;
...
public class ModelTools {
	...
	/**
	 * Sets the content of the specified selection model to be the whole tracks the
	 * selected spots belong to. Other selected edges are removed from the
	 * selection.
	 * 
	...
	/**
	 * Sets the content of the specified selection model to be the whole tracks the
	 * selected spots belong to, but searched for only forward in time (downward).
	...
	/**
	 * Sets the content of the specified selection model to be the whole tracks the
	 * selected spots belong to, but searched for only backward in time (backward).
	 * Other selected edges are removed from the selection.
	 * 
	 * @param selectionModel the {@link SelectionModel} that will be updated by this
	 *                       call.
	 ...
	 * @param fm      the {@link FeatureModel} to read feature values from.
	 * @return a new {@link Comparator}.
	 */
	public final static Comparator<DefaultWeightedEdge> featureEdgeComparator(final String feature,
