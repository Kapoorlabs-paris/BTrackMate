...
import fiji.plugin.globalbtrackmate.tracking.LAPTrackerFactory;
...
public class SparseLAPTrackerFactory extends LAPTrackerFactory {
	...
	public static final String THIS_INFO_TEXT = "<html>"
			...
			+ "Jaqaman <i> et al.</i>, 2008, Nature Methods. <br>" + "<p>"
			...
			+ "for gap-closing (missing detection), splitting and merging events.  <br> " + "<p>"
			...
			+ "Penalties can be set to favor linking between spots that have similar  <br> " + "features. " + "<p>"
			+ "Solving the LAP relies on the Jonker-Volgenant solver, and a sparse cost "
			+ "matrix formulation, allowing it to handle very large problems. " + "</html>";
