...
import static fiji.plugin.globalbtrackmate.gui.Icons.CANCEL_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.DISPLAY_CONFIG_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.LOG_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.NEXT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.PREVIOUS_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.REVERT_ICON;
import static fiji.plugin.globalbtrackmate.gui.Icons.SAVE_ICON;
...
import fiji.plugin.globalbtrackmate.gui.wizard.TransitionAnimator.Direction;
...
public class WizardController {
	...
	private void exec(final Runnable runnable) {
		...
		final EverythingDisablerAndReenabler reenabler = new EverythingDisablerAndReenabler(wizardPanel.panelButtons,
