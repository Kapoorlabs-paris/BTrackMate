...
import fiji.plugin.globalbtrackmate.gui.components.CategoryJComboBox;
...
public class StyleElements {
	...
	public static ColormapElement colormapElement(final String label, final Supplier<Colormap> get,
			final Consumer<Colormap> set) {
	...
	public static BoundedDoubleElement boundedDoubleElement(final String label, final double rangeMin,
			final double rangeMax, final DoubleSupplier get, final Consumer<Double> set) {
	...
	public static DoubleElement doubleElement(final String label, final DoubleSupplier get,
	...
	public static FeatureElement featureElement(final String label, final Supplier<TrackMateObject> typeGet,
			final Supplier<String> featureGet, final BiConsumer<TrackMateObject, String> set) {
	...
	public static CategoryJComboBox<TrackMateObject, String> linkedFeatureSelector(final FeatureElement element) {
		...
		final CategoryJComboBox<TrackMateObject, String> selector = FeatureDisplaySelector.createComboBoxSelector(null,
				settings);
	...
	public static JComboBox<Colormap> linkedColormapChooser(final ColormapElement element) {
		final JComboBox<Colormap> cb = new JComboBox<Colormap>(Colormap.getAvailableLUTs().toArray(new Colormap[] {}));
	...
	private static final class ColormapRenderer extends JPanel implements ListCellRenderer<Colormap> {
		...
		@Override
		public Component getListCellRendererComponent(final JList<? extends Colormap> list, final Colormap value,
