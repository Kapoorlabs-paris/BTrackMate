...
public class FeatureModel {
	...
	/**
	 * Instantiates a new feature model. The basic spot features (POSITON_*, RADIUS,
	 * FRAME, QUALITY) are declared. Edge and track feature declarations are left
	 * blank.
	 *
	 * @param model the parent {@link Model}.
	 */
	protected FeatureModel(final Model model) {
		...
		declareSpotFeatures(Spot.FEATURES, Spot.FEATURE_NAMES, Spot.FEATURE_SHORT_NAMES, Spot.FEATURE_DIMENSIONS,
				Spot.IS_INT);
		declareEdgeFeatures(EdgeTargetAnalyzer.FEATURES, EdgeTargetAnalyzer.FEATURE_NAMES,
				EdgeTargetAnalyzer.FEATURE_SHORT_NAMES, EdgeTargetAnalyzer.FEATURE_DIMENSIONS,
				EdgeTargetAnalyzer.IS_INT);
		declareTrackFeatures(TrackIndexAnalyzer.FEATURES, TrackIndexAnalyzer.FEATURE_NAMES,
				TrackIndexAnalyzer.FEATURE_SHORT_NAMES, TrackIndexAnalyzer.FEATURE_DIMENSIONS,
	 ...
	 * @param isIntFeature      whether some of these features are made of
	 *                          <code>int</code>s ( <code>true</code>) or
	 *                          <code>double</code>s (<code>false</code> ).
	 */
	...
	/**
	 * Returns the dimension mapping of the track features that are dealt with in
	 * this model.
	 * 
	...
	/**
	 * Remove the value of the designated feature for the track with the specified
	 * ID.
	 * 
	...
	/*
	 * SPOT FEATURES the spot features are stored in the Spot object themselves, but
	...
	/**
	 * Returns the short name mapping of the spot features that are dealt with in
	 * this model.
	 *
